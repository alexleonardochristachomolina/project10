...
import font_instead from "./images/font_instead.png";
import font_instead_dark from "./images/font_instead_dark.png";
...
const style = {
  ...
  ".css-1qiynlt-MuiFormControl-root-MuiTextField-root .MuiInput-underline:before": {
    borderBottom:isDarkMode === true ? '1px solid white !important' : '1px solid black !important' 
  },
      ...
      >
        ...
        >
          ...
          <div id="unlockpage" style={{ padding: 30 }}>
            ...
            <div style={{ display: 'flex', justifyItems: 'center', alignItems: 'center', width: '100%', justifyContent: 'center', paddingTop: 20 }}>

              {isDarkMode === true ? (<img src={font_instead_dark} />) : (<img src={font_instead} />)}

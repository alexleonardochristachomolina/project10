...
const BannerDiscount = () => {
  return (
    <div className="grid grid-cols-2 w-11/12 justify-center mx-auto">
      {/* First Section */}
      <div className="flex flex-col bg-[#237CFF] py-5 px-8 rounded-s-md">
      ...
      <div className="relative flex items-center justify-end bg-[#005ADE] py-5 px-8 rounded-e-md">
        {/* First Section */}
